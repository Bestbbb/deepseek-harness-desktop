...
export const zh = {
  ...
  'message.failure.missingCredential': '需要登录或配置 API 密钥',
  'message.credential.openSettings': '配置模型',
...
export const en = {
  ...
  'message.failure.missingCredential': 'Sign in or configure an API key',
  'message.credential.openSettings': 'Configure model',
