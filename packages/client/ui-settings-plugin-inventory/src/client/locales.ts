...
export const zh = {
  ...
  retry: '重试',
  refresh: '刷新状态',
  waitingConnection: '等待连接，插件状态尚未确认。',
  staleError: '刷新失败，以下为上次读取的状态。请重试。',
  stateHelp: '“已启用”表示配置允许加载，不代表插件已运行或账号已登录。',
  search: '搜索插件',
  empty: '暂无插件。',
  emptySearch: '没有匹配的插件。',
  presetTitle: '会话插件',
...
export const en = {
  ...
  waitingConnection: 'Waiting for a connection. Plugin state is not confirmed.',
  staleError: 'Refresh failed. Showing the last retrieved state. Please retry.',
  stateHelp: 'Enabled means configuration permits loading, not that the plugin is running or an account is signed in.',
  ...
  runtime: 'Status',
  unobserved: 'No running instance observed',
