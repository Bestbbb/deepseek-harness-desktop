...
export const en = {
  ...
  credentialRequired: 'API key required',
  credentialAction: 'Configure API key',
  ...
  onboardingDescription: 'Connect DeepSeek below, or choose another model provider. You can change providers later in Settings.',
  onboardingOtherProvider: 'Choose another provider',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  credentialRequired: '需要配置 API 密钥',
  credentialAction: '配置 API 密钥',
  ...
  onboardingDescription: '在下方配置 DeepSeek，或选择其他模型提供方。之后可随时在设置中切换。',
  onboardingOtherProvider: '选择其他模型提供方',
