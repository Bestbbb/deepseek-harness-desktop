...
Keep wire types, request serialization, transport parsing, chunk translation, and the adapter class as separate responsibilities; [`llm-deepseek`](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/packages/llm/llm-deepseek/README.md) is the reference layout.

## Verification

Follow the [repository testing policy](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/docs/testing.md), which owns adapter coverage, real-provider checks, and published-entry requirements.
