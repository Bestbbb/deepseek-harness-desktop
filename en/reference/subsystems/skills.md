...
The [skill capability family](https://github.com/Bestbbb/deepseek-harness-desktop/tree/main/packages/skill) includes the Service Definition ([dsh-skill](https://github.com/Bestbbb/deepseek-harness-desktop/tree/main/packages/skill/skill), `ctx.skills`), the local Service Provider ([dsh-skill-filesystem](https://github.com/Bestbbb/deepseek-harness-desktop/tree/main/packages/skill/skill-filesystem)), the optional packaged badge provider ([dsh-skill-badge](https://github.com/Bestbbb/deepseek-harness-desktop/tree/main/packages/skill/skill-badge)), and the Consumer ([dsh-tool-skill](https://github.com/Bestbbb/deepseek-harness-desktop/tree/main/packages/skill/tool-skill)). The registry merges provider catalogs across its host and per-scope layers; providers contribute local or packaged skills; the Consumer owns the initial and replacement catalogs plus the model-facing `skill` tool. Skills are optional instructions, not session events, so their vocabulary lives here rather than in [core.md](./core.md).

Source: [`packages/skill/skill/src/index.ts`](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/packages/skill/skill/src/index.ts), [`packages/skill/skill-filesystem/src/index.ts`](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/packages/skill/skill-filesystem/src/index.ts), [`packages/skill/skill-badge/src/index.ts`](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/packages/skill/skill-badge/src/index.ts), and [`packages/skill/tool-skill/src/index.ts`](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/packages/skill/tool-skill/src/index.ts).
...
Source: [`packages/api/session-controller/src/skill-catalog.ts`](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/packages/api/session-controller/src/skill-catalog.ts)
...
Source: [`packages/skill/skill/src/index.ts`](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/packages/skill/skill/src/index.ts)
