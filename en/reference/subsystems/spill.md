...
The spill storage seam — a [capability seam](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/.agents/notes/implemented/architecture/2026-07-08-tool-output-spill-files.md) that persists a tool's oversized text and returns a model-facing locator plus retrieval guidance, split across packages: Service Definition ([dsh-spill](https://github.com/Bestbbb/deepseek-harness-desktop/tree/main/packages/spill/spill), `ctx.spillStore`), Service Provider ([dsh-spill-local](https://github.com/Bestbbb/deepseek-harness-desktop/tree/main/packages/spill/spill-local), private session-scoped files on the host filesystem), and Consumer ([dsh-spill-policy](https://github.com/Bestbbb/deepseek-harness-desktop/tree/main/packages/spill/spill-policy), the `tools/post-execute` policy). Spill is **one optional capability**, not part of the agent-loop spine — so its vocabulary lives here, not in [core.md](./core.md). Preview mechanics stay in [dsh-output-retention](https://github.com/Bestbbb/deepseek-harness-desktop/tree/main/packages/util/output-retention); this seam only saves the final text the policy hands it.

Source: [`packages/spill/spill/src/types.ts`](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/packages/spill/spill/src/types.ts)
