...
Types shared by long-running producers, `ctx.jobs`, and job controls. The [runtime Agent Note](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/.agents/notes/implemented/architecture/2026-06-20-generic-long-running-tool-runtime.md) owns the design; this page records the exact fields and variants from [`packages/jobs/jobs/src/types.ts`](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/packages/jobs/jobs/src/types.ts).
...
The abstract [`JobRegistry`](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/packages/jobs/jobs/src/index.ts) Service Definition specifies atomic `start`, caller-scoped `get` and `list`, `read`, `kill`, bounded `wait`, failure-isolated `onJobDone` and `onJobsChanged` listeners, and `attachController`; [`LocalJobRegistry`](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/packages/jobs/jobs-local/src/index.ts) is the process-local Service Provider. Authorization compares owner sessions; owner cleanup and admission use the exact registered `Agent` instance. The local provider's positive-safe-integer `maxConcurrentJobsPerOwner` config defaults to `10` and counts `running` plus `stopping` records per exact owner, with one shared bucket for unowned jobs; terminal producer settlement releases capacity. See [`dsh-jobs`](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/packages/jobs/jobs/README.md) for the Service Definition contract, [`dsh-jobs-local`](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/packages/jobs/jobs-local/README.md) for the registry lifecycle and admission policy, and [`dsh-tool-jobs`](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/packages/jobs/tool-jobs/README.md) for the model-facing Consumer.
...
Source: [`packages/jobs/jobs/src/index.ts`](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/packages/jobs/jobs/src/index.ts)
