...
Types shared by generated Remote artifacts, the Host Gateway, and consumer API assemblies. The [Typert Gateway Agent Note](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/.agents/notes/implemented/architecture/2026-08-02-typert-remote-method-calls.md) owns the architecture and transport decisions; this page records the literal public contracts from [`dsh-typert-protocol`](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/packages/typert/protocol/src/types.ts) and [`dsh-api-gateway`](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/packages/api/gateway/src/types.ts).
