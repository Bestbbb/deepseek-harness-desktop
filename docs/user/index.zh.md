...
description: "基于 DeepSeek Harness 的社区桌面应用。配置自己的模型，在本地项目中工作，并通过插件扩展功能。"
---
...
![配置模型前的 Harness Desktop 会话工作区](../assets/desktop/harness-desktop-main.png)
...
[模型配置与认证](guide/providers.zh.md)

</div><div class="dsh-models-preview">

![包含提供方配置控件的 Harness Desktop 模型设置](../assets/desktop/harness-desktop-models.png)
...
[桌面架构](../../apps/desktop/README.zh.md)
...
[插件开发](develop/basic/index.zh.md)
