...
| [desktop.md](desktop.md) | the optional native desktop seam: host reachability, window activation, notifications, autostart, and the authenticated Tauri bridge boundary |
