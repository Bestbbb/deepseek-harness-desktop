...
来源：[`packages/desktop/bundle-preparation/src/types.ts:149`](../packages/desktop/bundle-preparation/src/types.ts)
...
来源：[`packages/desktop/delegation-launcher/src/index.ts:16`](../packages/desktop/delegation-launcher/src/index.ts)
...
来源：[`packages/desktop/desktop-native/src/index.ts:54`](../packages/desktop/desktop-native/src/index.ts)
...
- `@deepseek-ai/dsh-bundle-marketplace` — 需要 `bundlePreparation` · `desktop`（[`packages/desktop/bundle-marketplace/src/index.ts`](../packages/desktop/bundle-marketplace/src/index.ts)）
...
- `@deepseek-ai/dsh-notification-controls` — 需要 `settings`（[`packages/desktop/notification-controls/src/index.ts`](../packages/desktop/notification-controls/src/index.ts)）
...
- `@deepseek-ai/dsh-desktop` — 抽象 `DesktopHost`（[`packages/desktop/desktop/src/index.ts`](../packages/desktop/desktop/src/index.ts)）
