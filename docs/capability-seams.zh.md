...
| `ctx.desktop` | `seam` | [`desktop`](../packages/desktop/desktop) | [`desktop-native`](../packages/desktop/desktop-native) | - | - | 桌面专属提供方通过每次启动独立认证的回环 bridge，把受限原生操作 allowlist 转发给 Tauri 宿主；浏览器与 headless 组合不挂载该 seam。 |
