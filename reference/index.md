...
组装机制见 [app-boot](https://github.com/Bestbbb/deepseek-harness-desktop/blob/main/packages/boot/app-boot/README.zh.md#profiles)；配置字段见生成的[配置目录](./config-catalog.md)。
