...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  DesktopNotification: 'desktop.md',
  DesktopStatus: 'desktop.md',
  DesktopProfileName: 'desktop.md',
  DesktopProfileCandidate: 'desktop.md',
  DesktopProfileSelection: 'desktop.md',
  MarketplaceEntry: 'desktop.md',
  MarketplaceSnapshot: 'desktop.md',
  MarketplaceProfile: 'desktop.md',
  ...
  PreparedComposition: 'desktop.md',
  PreparedRemoval: 'desktop.md',
  ProfileBundle: 'desktop.md',
